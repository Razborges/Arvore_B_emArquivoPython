...
pagina_aux = pagina_raiz.le_pagina(arquivo)
pagina_aux.atualiza_qtd_chaves()
pagina_aux.chaves[0].set_pos_pagina_menor_chave(arquivo.seek(0, 2))
arquivo.seek(0, 2)
pagina1.escreve_pagina(arquivo)
pagina_aux.set_pos_pagina_maior_chave(arquivo.seek(0, 2))
...
arquivo.seek(pagina_aux.chaves[0].pos_pagina_menor_chave)
pagina1.escreve_pagina(arquivo)
arquivo.seek(pagina_aux.pos_pagina_maior_chave)
pagina2.escreve_pagina(arquivo)
